...
public void getAddressTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("address");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.47508985";
...
public void getStateTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("state");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.0498932";
	field.set(inst, expected);
...
public void setPatient_idTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("patient_id");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	int expected = 1379426568;
...
public void getDoctorTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("doctor");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
...
public void getFirst_nameTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("first_name");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.7427132";
	field.set(inst, expected);
...
public void setFirst_nameTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.6150151";
...
public void getLast_nameTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("last_name");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.40567207";
	field.set(inst, expected);
...
public void setLast_nameTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.30249614";
...
public void getSsnTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("ssn");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	int expected = -1333619093;
	field.set(inst, expected);
...
public void getDobTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("dob");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
...
public void getPhone_numberTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("phone_number");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.88905466";
	field.set(inst, expected);
...
public void setPhone_numberTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.3852055";
...
public void getEmailTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("email");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.99519855";
	field.set(inst, expected);
...
public void setEmailTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.9196542";
...
public void getMarital_statusTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("marital_status");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.93441963";
	field.set(inst, expected);
...
public void setMarital_statusTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.10400075";
...
public void getGenderTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("gender");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.29119623";
	field.set(inst, expected);
...
public void setGenderTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.926747";
...
public void getEthnicityTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("ethnicity");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.52788264";
	field.set(inst, expected);
...
public void setEthnicityTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.5195642";
...
public void getOccupationTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("occupation");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.25241083";
	field.set(inst, expected);
...
public void setOccupationTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.60538095";
...
public void getCityTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("city");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.658985";
	field.set(inst, expected);
...
public void setCityTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.33375508";
...
public void setStateTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.027852893";
...
public void getZipcodeTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("zipcode");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	int expected = -998739166;
	field.set(inst, expected);
...
public void getInsurance_providerTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("insurance_provider");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.5687272";
	field.set(inst, expected);
...
public void setInsurance_providerTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.20497972";
...
public void getInsurance_idTest() throws NoSuchFieldException, IllegalAccessException {
	Field field = com.ex.beans.PatientProfile.class.getDeclaredField("insurance_id");
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	int expected = 413123859;
	field.set(inst, expected);
...
public void setAddressTest() throws NoSuchFieldException, IllegalAccessException {
	...
	field.setAccessible(true);
	com.ex.beans.PatientProfile inst = new com.ex.beans.PatientProfile();
	java.lang.String expected = "test string 0.23924583";
